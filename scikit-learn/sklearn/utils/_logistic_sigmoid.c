...
static const char __pyx_k_vagrant_scikit_learn_sklearn_ut[] = "/vagrant/scikit-learn/sklearn/utils/_logistic_sigmoid.pyx";
 ...
 */
  ...
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(4, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_vagrant_scikit_learn_sklearn_ut, __pyx_n_s_log_logistic_sigmoid, 21, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
